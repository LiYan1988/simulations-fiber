classdef SinglePolarization < matlab.mixin.Copyable
    ...
    methods
        ...
        function saveSimulationResult(obj)
            ...
            matFileLevel1 = sprintf('%s%dResultsLevel1.mat', obj.simulationName, obj.simulationId);
            matFileLevel1 = fullfile(obj.resultFolder, matFileLevel1);
            save(matFileLevel1, 'result');
            
            matFileLevel2 = sprintf('%s%dResultsLevel2.mat', obj.simulationName, obj.simulationId);
            matFileLevel2 = fullfile(obj.resultFolder, matFileLevel2);
            save(matFileLevel2, 'result', 'symbol');
            
            matFileLevel3 = sprintf('%s%dResultsLevel3.mat', obj.simulationName, obj.simulationId);
