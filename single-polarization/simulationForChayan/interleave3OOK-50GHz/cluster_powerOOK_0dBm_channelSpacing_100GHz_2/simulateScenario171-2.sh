...
#SBATCH -J simulateScenario171-2
#SBATCH -N 1
#SBATCH -t 0-10:00:00
#SBATCH -o simulateScenario171-2.stdout
#SBATCH -e simulateScenario171-2.stderr
...
mkdir $SLURM_SUBMIT_DIR/simulateScenario171-2
cp -rf $TMPDIR/results/* $SLURM_SUBMIT_DIR/simulateScenario171-2
rm -rf $TMPDIR/*
