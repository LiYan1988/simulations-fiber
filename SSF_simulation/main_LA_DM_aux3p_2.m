...
param.Nsc = 2;             %Numero di sottoportanti
...
param.Nspan = 100;         %Numero di tratte
...
fn_sgs_prop = 'vec/sgs_LA_DM_wdm5_100x60_2sc.mat';

%* AIR calc
N_samples = param.Nit_mc*(param.Nu-param.No);
eta = repmat(linspace(0.0001,0.00001,N_samples),3,1); % step-size coefficient for gradient algorithm (adaptive)
N_particle = 5000;
fn_air_res = 'vec/res_LA_DM_wdm5_100x60_2sc.mat';
